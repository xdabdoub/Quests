package me.yhamarsheh.dabquests.storage;
...
public class SQLDatabase {
    ...
    private final String TABLE_NAME = "quests_data";

    public SQLDatabase(DabQuests plugin) {
        this.plugin = plugin;
    ...
    public void createDataTable() {
        ...
        String query = "CREATE TABLE IF NOT EXISTS " + TABLE_NAME + " (" +
                "UUID VARCHAR(100),QUESTS TEXT,PRIMARY KEY (UUID))";
        try {
